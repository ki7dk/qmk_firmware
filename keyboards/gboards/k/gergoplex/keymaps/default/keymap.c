 ...
 * `------+-----+-----+------+----'      `--------------------------------'
 *  .-------------------------.           .-----------------.
 *  |ESC/META|bsp/ALT|bsp(SYM)|           |ent(NUM)| spc|TAB|
 *  '-------------------------'           '-----------------'
 */
[BASE] = LAYOUT_gergoplex(
    ...
    MT(MOD_RSFT, KC_Z),KC_X, KC_C, KC_V, KC_B,    KC_N, KC_M, KC_COMM, KC_DOT, MT(MOD_RSFT, KC_SLSH),
     ...
     MT(MOD_LALT, KC_ESC), MT(MOD_LGUI, KC_BSPC), LT(SYMB, KC_BSPC),                  // Left
    LT(NUMB, KC_ENT), MT(KC_LSFT, KC_SPC) , MT(MOD_RSFT, KC_TAB)                                // Right
    ),
...
[SYMB] = LAYOUT_gergoplex(
    ...
    KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_TRNS,   KC_PLUS, KC_MINS, KC_SLSH, KC_ASTR, KC_QUOT,
    KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TRNS,   KC_AMPR, KC_EQL,  KC_COMM, KC_DOT,  KC_MINS,
